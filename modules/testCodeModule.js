...
//       if (argEl.value[0] === '[') {
//         args.push(JSON.parse(argEl.value))
//       } else if (argEl.value.includes('\\n')) {
//         args.push(JSON.parse(argEl.value))
//       } else if (!isNaN(Number(argEl.value.slice(1, argEl.value.length - 1))) &&
//         (argEl.value[0] === "'" || argEl.value[0] === "\"")) {
//         args.push(Number(argEl.value.slice(1, argEl.value.length - 1)));
//       } else {
//         args.push(argEl.value)
//       }
//     });
